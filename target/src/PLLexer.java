...
public class PLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "FOR", "FUNCTION", "DO", "WHILE", "IF", "ELSE", "PRINT", "ID", 
			"INT", "FLOAT", "BOOL", "STRING", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
			"SEMI", "COMMA", "ASSIGN", "PLUS", "MINUS", "MULT", "DIV", "LT", "GT", 
			"LE", "GE", "EQ", "NE", "AND", "OR", "NOT", "RANGE", "LINE_COMMENT", 
			"COMMENT", "WS", "DIGIT", "ESC"
		};
	}
